...
urlpatterns = [
    ...
    path('confirm/emap2secplus/<uuid:id>/',
         views.confirmEmap2SecPlus, name='confirm_emap2sec+'),
    ...
    path('view/emap2secplus/<uuid:id>/', views.viewEmap2SecPlus, name='view_emap2sec+'),
