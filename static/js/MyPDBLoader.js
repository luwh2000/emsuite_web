...
var MyPDBLoader = function (manager) {

    Loader.call(this, manager);

};

MyPDBLoader.prototype = Object.assign(Object.create(Loader.prototype), {

    constructor: MyPDBLoader,
    ...
    parse: function (text) {
        ...
        var chainColors = { A: [0, 123, 255], B: [255, 193, 7], C: [40, 167, 69], D: [255, 255, 255], };
        ...
        for (var i = 0, l = lines.length; i < l; i++) {
            ...
            if (lines[i].substr(0, 4) === 'ATOM' || lines[i].substr(0, 6) === 'HETATM') {
                ...
                var atomData = [x, y, z, chainColors[chain], capitalize(e), chain];
